...
class Block:
    ...
    def mine_block(last_block, data):
        """
        Mine a block based on the given last block and data, until a block a block hash is found
    ...
    def adjust_difficulty(last_block, new_timestamp):
        """
        Calculate the difficulty based on the MINE_RATE.
...
def main():
    ...
    try:
        Block.is_valid_block(Block.genesis(), bad_block)
