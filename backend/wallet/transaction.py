...
class Transaction():
    """
    Document of an exchange in currency from one send to one or more
    recipients
    """
    def __init__(self,
                 sender_wallet=None,
    ...
    def create_input(self, sender_wallet, output):
        ...
        Sign the tansaction and include the sender's public key and address
        """
        return {
    ...
    def to_json(self):        
        """
        Serialize the transaction into a dictionary of ist attribute
...
def main():
    transaction = Transaction(Wallet(), "recipient_address", 15)
